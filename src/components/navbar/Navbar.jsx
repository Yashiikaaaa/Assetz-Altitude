...
import logo from "../../assets/navbar/logo.png"; // Importing Prestige Logo
...
export const Banner = ({ setContactModal }) => {
  ...
  return (
    (isBannerVisible) && (
      <div className="w-screen bg-white text-black text-center p-[10px] flex justify-center items-center gap-[16px] max-h-[40px] z-30">
...
export const Navbar = ({ sitevisitmodal, setSiteVisitModal, setContactModal }) => {
  ...
  return (
      <div className="font-body fixed w-full z-20 top-0 start-0 bg-black shadow ">
